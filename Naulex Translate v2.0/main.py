# ============================================================
#  Naulex Translate — PyWebView Desktop App  v2.0
#  EXE-safe: frozen check + one-time install guard
# ============================================================
...
# ── Auto-install: HANYA jalan saat mode script (.py) ──────
# Kalau frozen (EXE), semua library sudah ter-bundle — skip total.
...
def _hotkey_init():
    time.sleep(0.4)
    _log("[INFO] Naulex Translate v2.0")
    time.sleep(0.1)
